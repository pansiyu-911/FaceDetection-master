...
public class Main1Activity extends Activity {
    ...
    public static void setEt_username(EditText et_username) {
        Main1Activity.et_username = et_username;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        set_ip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Main1Activity.this,Url.class);
    ...
    public void login(View view){
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                switch (result){
                    case "1":
                        Intent intent1=new Intent(Main1Activity.this,Main3Activity.class);
                    ...
                    case "3":
                        Looper.prepare();
                        Toast.makeText(Main1Activity.this,"用户名不正确",Toast.LENGTH_SHORT).show();
                        Looper.loop();
                        break;
                    case "4":
                        Looper.prepare();
                       Toast.makeText(Main1Activity.this,"密码不正确",Toast.LENGTH_SHORT).show();
                        Looper.loop();
                        break;
                }
            }
